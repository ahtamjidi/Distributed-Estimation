...
%         end
% % % %     if  BC_distance(x_gt,P_cen,x_gt,P) - BC_distance(x_gt,P_cen,x_gt,P_gold{j_agent})>0.0001
% % % % 
% % % %         disp(['BC_dist',num2str(j_agent)])
% % % %     end
% % % %     if (trace( P_gold{j_agent} )/ trace(P))>1
% % % %         disp(['trace gold vs hybrid',num2str(j_agent)])
% % % %     end
% % % %     if (trace( P_cen) / trace(P))>1
% % % %         disp(['trace gold vs hybrid',num2str(j_agent)])
% % % %     end
% % % %     if (det( P_gold{j_agent} )/ det(P))>1
% % % %         disp(['det gold vs hybrid',num2str(j_agent)])
% % % %     end
% % % %     if (det( P_cen) / det(P))>1
% % % %         disp(['det gold vs hybrid',num2str(j_agent)])
% % % %     end
% % % %     
